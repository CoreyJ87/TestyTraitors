...
{
    wp_enqueue_style("admin_style", path_join(WP_PLUGIN_URL, basename(dirname(__FILE__)) . '/featuredSliderAdmin.css'));
    wp_enqueue_style('jquery-ui-css', path_join(WP_PLUGIN_URL, basename(dirname(__FILE__)) . '/jquery-ui.min.css'));

    wp_enqueue_script('jQuery', path_join(WP_PLUGIN_URL, basename(dirname(__FILE__)) . '/jquery-2.1.1.min.js'), array(), '1.0.0', true);
    ...
    wp_enqueue_script('jqueryForm', path_join(WP_PLUGIN_URL, basename(dirname(__FILE__)) . '/jquery.form.min.js'), array(), '1.0.0', true);
