	...
	?><?php mysite_before_post( array( 'post_id' => get_the_ID() ) ); ?>
		...
		<div class="<?php echo $layout['content_class']; ?>">
			...
			<div class="post_excerpt">
                ...
                <?php echo '<p style="border-bottom: 1px solid #FFF;">Posted by: <span class="meta_author">' . $attr['before'] . $attr['text'] . ' <a href="' . get_author_posts_url( get_the_author_meta( 'ID' ) ) . '">' . get_the_author_meta( 'display_name' ) . '</a>'. mysite_after_entry() . $attr['after'] .'</span></p>';
